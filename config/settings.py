...
SECRET_KEY = 'django-insecure-ygt!!rm5=q(1trwa9n=p6s3bhjl)^^ehag^amb-66om(5pd6vk'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Boss Media Group Test',
    'DESCRIPTION': 'API documentation for Boss Media Group Test',
    'VERSION': '1.0.0',
}
