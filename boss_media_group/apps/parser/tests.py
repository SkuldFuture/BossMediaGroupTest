...
from boss_media_group.apps.parser.astana_hub_parser import parse_10_astana_hub_html, astana_hub_parser
...
@patch("boss_media_group.apps.parser.services.fetch_astana_hub_html")
